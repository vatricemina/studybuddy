...
function GenerateQuizPage(){
    ...
    async function fetchData(){
        ...
        const subjectResponse=await axios.get(`${import.meta.env.VITE_API_URL}/api/subjects`, {
    ...
    async function handleGenerate(){
        ...
        try{
            ...
            navigate(`/topics/${selectedTopic}/quiz`, {state: {quiz:response.data}});
        }catch(e){
    ...
    return (
        <div>
            <div className="mb-8">
                <h1 className="text-4xl font-extrabold text-emerald-50 mb-2">New Quiz</h1>
